...
ssh-keygen -f "$HOME/.ssh/known_hosts" -R "10.1.0.6"
ssh-keygen -f "$HOME/.ssh/known_hosts" -R "10.1.0.7"
ssh-keygen -f "$HOME/.ssh/known_hosts" -R "10.1.0.8"
ssh-keygen -f "$HOME/.ssh/known_hosts" -R "10.1.0.9"
ssh-keygen -f "$HOME/.ssh/known_hosts" -R "10.1.0.10"
